<!--재직증명서 템플릿-->
<template>
  <div class="workDocument-container">
    <div class="inner">
      <h1 class="title_h1">재직증명서</h1>
        <div class="table_div">
        ...
        <div class="table_div_text">
          <h4 class="title_h3_center">상기와 같이 재직하고 있음을 증명합니다.</h4>
        </div>
...
// 컴포넌트 내에서 게터를 사용할 수 있도록 mapGetters를 사용합니다.
  ...
  methods: {
    getTodayFromStore() {
      ...
      this.endDate = this.getToday; // Vuex의 today 값을 가져옵니다.
      console.log('Today:', this.getToday);
      // Vuex의 today 값을 그대로 반환합니다.
      return this.endDate;
    },
